...
, fact_assetcosts as (
    select
        ...
        u.unit_price * material_quantity * ifnull(av.asset_region_price_offset,1) as drv_replacement_cost,
        cast(drv_replacement_cost as number(18,4)) as replacement_cost,
        cast(ifnull(field_replacement_estimate,drv_replacement_cost) as number(12,2)) as adjusted_replacement_cost,
        installation_date,
